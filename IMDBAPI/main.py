...
def api_usage_guide():
    ...
    return {
        "base_url": "https://imdbapi-gv4r.onrender.com",
        "apis": [
            {
                "name": "Search by String",
                "endpoint": "/search/{query}",
                "description": "Search for movies, TV shows, and people by a string query.",
                "example_call": "fetch('https://imdbapi-gv4r.onrender.com/search/inception?limit=10')"
            },
            {
                "name": "Get Movie Details",
                "endpoint": "/movie/{movie_id}",
                "description": "Get full movie/show details by its IMDb ID.",
                "example_call": "fetch('https://imdbapi-gv4r.onrender.com/movie/tt0468569')"
            },
            {
